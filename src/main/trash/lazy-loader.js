...
async function loadDocsModules() {
    ...
    try {
        ...
        await Promise.all([
            loadScript('js/docs.js', 'docs-js'),
            loadScript('js/marked-extension.js', 'marked-extension-js'),
            loadScript('js/docs-products.js', 'docs-products-js'),
            loadScript('js/docs-page-actions.js', 'docs-page-actions-js')
        ]);
...
async function loadSearchModule() {
    ...
    try {
        ...
        // Lade Search Modul
        await loadScript('js/docs-search.js', 'docs-search-js');
